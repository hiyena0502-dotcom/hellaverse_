(()=>{
if(window.__HELLAVERSE_DIALOGUE_FOUNDATION_V1__)return;
window.__HELLAVERSE_DIALOGUE_FOUNDATION_V1__=1;
...
document.addEventListener('click',e=>{
  ...
  if(t.closest('[data-hv-health-close]')){e.preventDefault();const root=$('#modalRoot');if(root)root.innerHTML='';return}
