...
const scripts=[
  ...
  ['classic','js/item-catalog-rebalance.js?v=3'],
  ['classic','js/charlie-collection-canon-repair-v1.js?v=2'],
  ['classic','js/lucifer-item-dialogue-pack-v1.js?v=2'],
  ...
  ['classic','js/content-integrity-repair-v1.js?v=2'],
