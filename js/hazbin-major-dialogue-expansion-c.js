(()=>{
'use strict';
if(window.__HELLAVERSE_MAJOR_DIALOGUE_EXPANSION_C_V2__)return;
window.__HELLAVERSE_MAJOR_DIALOGUE_EXPANSION_C_V2__=1;
const K='hellaverse_dialogue_state_v1',VK='hellaverse_major_dialogue_expansion_c_v2',PACK='hazbin-major-expansion-c-v2';
...
const CONVERSATION_PROMPTS={"기타 자랑":["제일 자신 있는 곡이 뭐예요?","누가 연주 평가하면 기분 나빠요?"],"첫 인간이라는 자부심":["첫 인간이라는 게 아직도 그렇게 중요해요?","그 자부심 때문에 부담 느낀 적은 없어요?"],"Lucifer 경쟁심":["Lucifer한테 꼭 이기고 싶은 이유가 뭐예요?","그 사람을 의식하지 않는 척하는 건 아니고요?"],"천국의 명성":["천국에서 사람들이 보는 당신이 진짜 당신이랑 같아요?","명성이 떨어질까 걱정한 적 있어요?"],"전투 전의 허세":["싸우기 전에 일부러 더 떠드는 거예요?","겁날 때도 똑같이 웃어요?"],"시청률 그래프":["숫자가 떨어지면 제일 먼저 뭘 바꿔요?","시청률보다 더 신경 쓰이는 지표도 있어요?"],"Alastor의 존재감":["Alastor가 돌아온 게 그렇게 거슬려요?","그 사람한테 꼭 증명하고 싶은 게 있어요?"],"Vees의 균형":["셋 중 누가 제일 통제하기 어려워요?","서로 싸워도 팀이 유지되는 이유가 뭐예요?"],"새 기술":["이번 기술로 제일 바꾸고 싶은 건 뭐예요?","새 기술이 실패하면 바로 버려요?"],"통제와 방송":["방송을 통제한다는 게 사람까지 통제하는 거예요?","예상 밖의 반응이 나오면 즐기기도 해요?"],"촬영 스케줄":["일정을 그렇게 빡빡하게 잡는 이유가 뭐예요?","누가 일정대로 안 움직이면 바로 화나요?"],"Vees와 사업":["Vees 안에서 본인이 맡는 건 정확히 뭐예요?","둘을 완전히 믿지는 않는 거죠?"],"Angel에 대한 집착":["Angel한테 그렇게 집착하는 이유가 뭐예요?","그게 통제 욕구라는 생각은 안 해봤어요?"],"스튜디오의 규칙":["가장 절대적인 규칙은 뭐예요?","그 규칙은 본인한테도 똑같이 적용돼요?"],"자기 이미지":["사람들이 당신을 어떻게 보는 게 제일 중요해요?","그 이미지가 깨지는 게 두려워요?"],"트렌드 속도":["요즘 제일 빨리 변하는 건 뭐예요?","놓치면 끝이라고 느끼는 이유가 있어요?"],"Overlord 회의":["회의에서 제일 답답한 유형은 누구예요?","정보를 빨리 쓰는 게 항상 이긴다고 봐요?"],"Carmilla와의 긴장":["Carmilla의 어떤 점은 인정해요?","그 사람이 정보를 숨기는 게 그렇게 싫어요?"],"Vees의 역할":["셋 중 본인 역할이 제일 중요하다고 봐요?","서로 쓸모가 맞아서 유지되는 관계예요?"],"패션과 권력":["옷으로 권력을 보여준다는 게 어떤 뜻이에요?","취향을 전략으로 쓰는 사람은 어떻게 구분해요?"]};
