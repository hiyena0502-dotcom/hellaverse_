...
async function loadStableCore(){
  const src='js/hv-stable.js?v=62';
  try{
...
await loadClassic('js/dialogue-content-normalize-once-v1.js?v=3');
...
const scripts=[
  ['classic','js/dialogue-token-renderer.js?v=5'],
  ...
  ['classic','js/item-system-v2.js?v=3'],
