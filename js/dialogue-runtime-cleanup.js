(()=>{
'use strict';
if(window.__HELLAVERSE_DIALOGUE_RUNTIME_CLEANUP_V1__)return;
window.__HELLAVERSE_DIALOGUE_RUNTIME_CLEANUP_V1__=1;
...
document.addEventListener('click',e=>{
 ...
 if(btn){const mode=modeFromButton(btn);if(['CONVERSATION','QUESTION','ACTION'].includes(mode)){pendingMode=mode;sessionStorage.setItem(RKEY,mode)}}
},true);
