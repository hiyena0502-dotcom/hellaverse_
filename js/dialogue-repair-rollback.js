(()=>{
'use strict';
if(window.__HELLAVERSE_DIALOGUE_REPAIR_ROLLBACK_V2__)return;
window.__HELLAVERSE_DIALOGUE_REPAIR_ROLLBACK_V2__=1;
...
window.__HV_DIALOGUE_REPAIR_ROLLBACK_READY__=(async()=>{
  ...
  }catch(error){console.warn('Temporary dialogue repair rollback skipped safely.',error);return{ok:false,error:String(error?.message||error)}}
})();
})();
